/*
 ...
 Source Schema         : pigxx_pay

 Target Server Type    : MariaDB
 Target Server Version : 100320
 File Encoding         : 65001

 Date: 08/04/2020 07:28:22
*/
...
CREATE TABLE `pay_channel`  (
  ...
  UNIQUE INDEX `IDX_MchId_MchOrderNo`(`channel_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '支付渠道表' ROW_FORMAT = Dynamic;
