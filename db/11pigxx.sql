...
CREATE TABLE `sys_log`  (
  ...
  `params` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `time` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '执行时间',
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0',
  `exception` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '日志表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (1, '0', '修改数据源表', 'pig', 'admin', '2020-04-07 12:39:23', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:74.0) Gecko/20100101 Firefox/74.0', '/dsconf', 'PUT', '', '29', '0', NULL, 1);
INSERT INTO `sys_log` VALUES (2, '0', '修改数据源表', 'pig', 'admin', '2020-04-07 12:39:39', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:74.0) Gecko/20100101 Firefox/74.0', '/dsconf', 'PUT', '', '22', '0', NULL, 1);
INSERT INTO `sys_log` VALUES (3, '0', '修改数据源表', 'pig', 'admin', '2020-04-07 12:39:54', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:74.0) Gecko/20100101 Firefox/74.0', '/dsconf', 'PUT', '', '24', '0', NULL, 1);
INSERT INTO `sys_log` VALUES (4, '0', '修改数据源表', 'pig', 'admin', '2020-04-07 12:40:07', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:74.0) Gecko/20100101 Firefox/74.0', '/dsconf', 'PUT', '', '21', '0', NULL, 1);
INSERT INTO `sys_log` VALUES (5, '0', '修改数据源表', 'pig', 'admin', '2020-04-07 12:40:20', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:74.0) Gecko/20100101 Firefox/74.0', '/dsconf', 'PUT', '', '23', '0', NULL, 1);
INSERT INTO `sys_log` VALUES (6, '0', '修改数据源表', 'pig', 'admin', '2020-04-07 12:40:32', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:74.0) Gecko/20100101 Firefox/74.0', '/dsconf', 'PUT', '', '20', '0', NULL, 1);
INSERT INTO `sys_log` VALUES (7, '0', '新增数据源表', 'pig', 'admin', '2020-04-07 12:46:52', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:74.0) Gecko/20100101 Firefox/74.0', '/dsconf', 'POST', '', '47', '0', NULL, 1);
INSERT INTO `sys_log` VALUES (8, '0', '新增生成记录', 'pig', 'admin', '2020-04-07 13:12:50', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:74.0) Gecko/20100101 Firefox/74.0', '/form', 'POST', '', '31', '0', NULL, 1);
...
CREATE TABLE `sys_route_conf`  (
  ...
  `predicates` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '断言',
  `filters` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '过滤器',
...
-- ----------------------------
INSERT INTO `sys_route_conf` VALUES (1, '工作流管理模块', 'pigx-oa-platform', '[{\"args\": {\"_genkey_0\": \"/act/**\"}, \"name\": \"Path\"}]', '[]', 'lb://pigx-oa-platform', 0, '2019-10-16 16:44:41', '2020-04-04 14:28:51', '0');
INSERT INTO `sys_route_conf` VALUES (2, '认证中心', 'pigx-auth', '[{\"args\": {\"_genkey_0\": \"/auth/**\"}, \"name\": \"Path\"}]', '[{\"args\": {}, \"name\": \"ValidateCodeGatewayFilter\"}, {\"args\": {}, \"name\": \"PasswordDecoderFilter\"}]', 'lb://pigx-auth', 0, '2019-10-16 16:44:41', '2020-04-04 14:28:48', '0');
...
CREATE TABLE `sys_user`  (
  ...
  `gitee_login` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '码云 标识',
  `osc_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '开源中国 标识',
  `tenant_id` int(11) NOT NULL DEFAULT 0 COMMENT '所属租户',
